...
function progressLinesFor(mode){
  switch(mode){
    case "mini_user":
      return ["五行を整えております…", "気質の傾向を組み立てています…", "言葉を静かに整えております…"];
    case "mini_partner":
      return ["お相手様の気配を辿っております…", "性質の偏りを見ています…", "読み筋を整えております…"];
    case "free_report":
      return ["縁の流れを読み解いております…", "分岐点の筋を照らしております…", "鑑定文を最終調整中でございます…"];
    case "paid_480":
    case "paid_980":
      return ["縁の芯を深く見ております…", "流れを週次で整えています…", "迷いが消える形に仕立てております…"];
    default:
      return ["少々お待ちくださいませ…", "読みを進めております…", "最終調整中でございます…"];
  }
}
